        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div id="instrucciones" className="mb-20" {...itemView(0)}>
            ...
            <div className="space-y-6 text-gray-600 dark:text-gray-300">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-brand-dark dark:text-white uppercase mb-2">Seguridad</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-brand-dark dark:text-white uppercase mb-2">Qué llevar</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-brand-dark dark:text-white uppercase mb-2">Comportamiento en montaña</h3>
          ...
          <motion.div id="simbolologia" className="mb-20" {...itemView(0.1)}>
            ...
            <div id="dificultad" className="mb-12">
              <h3 className="text-xl font-heading font-bold uppercase text-brand-dark dark:text-white mb-6">Niveles de Dificultad</h3>
              <div className="grid md:grid-cols-3 gap-6">
                <motion.div className="p-6 bg-green-500/10 dark:bg-green-500/20 rounded-lg border-2 border-green-500/30 dark:border-green-400/40" {...itemView(0.15)}>
                  ...
                  <h4 className="font-heading font-bold uppercase text-brand-dark dark:text-white mb-2">Fácil</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Terreno accesible, desnivel moderado. Ideal para principiantes y familias.</p>
                </motion.div>
                <motion.div className="p-6 bg-yellow-500/10 dark:bg-yellow-500/20 rounded-lg border-2 border-yellow-500/30 dark:border-yellow-400/40" {...itemView(0.2)}>
                  ...
                  <h4 className="font-heading font-bold uppercase text-brand-dark dark:text-white mb-2">Media</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Requiere condición física básica. Algunos tramos con mayor exigencia.</p>
                </motion.div>
                <motion.div className="p-6 bg-brand-primary/10 rounded-lg border-2 border-brand-primary/30" {...itemView(0.25)}>
                  ...
                  <h4 className="font-heading font-bold uppercase text-brand-dark dark:text-white mb-2">Alta</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Terreno técnico, condición física buena. Equipo especializado requerido.</p>
                </motion.div>
              </div>
            </div>

            <div className="mb-12">
              <h3 className="text-xl font-heading font-bold uppercase text-brand-dark dark:text-white mb-6">Equipo Necesario</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div className="flex gap-4 p-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-lg" {...itemView(0.3)}>
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-brand-dark dark:text-white">Mochila</h4>
                ...
                <motion.div className="flex gap-4 p-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-lg" {...itemView(0.35)}>
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-brand-dark dark:text-white">Bastones</h4>
                ...
                <motion.div className="flex gap-4 p-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-lg" {...itemView(0.4)}>
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-brand-dark dark:text-white">Casco</h4>
                ...
                <motion.div className="flex gap-4 p-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-lg" {...itemView(0.45)}>
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-brand-dark dark:text-white">Crampones</h4>
            ...
            <div>
              <h3 className="text-xl font-heading font-bold uppercase text-brand-dark dark:text-white mb-6">Señalética de Senderos</h3>
              <div className="grid md:grid-cols-2 gap-6">

  ...
  return (
    <div>
      ...
      <form
        ...
        className="bg-white border-2 border-gray-200 rounded-lg p-8 max-w-2xl"
      >
        <div className="space-y-6">
          ...
          <div className="pt-4 border-t border-gray-200">
            <h3 className="text-lg font-heading font-bold uppercase text-brand-dark mb-4">
              Redes Sociales
            </h3>
          ...
          <div className="pt-4 border-t border-gray-200">
            ...
            />
            <div className="mt-4 aspect-video bg-gray-100 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300">
              <p className="text-gray-500 font-heading uppercase text-sm">

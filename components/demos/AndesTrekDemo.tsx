    ...
    <div>
      ...
      <header className="relative h-screen min-h-[600px] flex items-center justify-center bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mt-20">
          <div className="text-xs md:text-sm font-heading tracking-[0.3em] uppercase mb-4 text-brand-primary font-bold bg-brand-dark/40 inline-block px-4 py-1 rounded backdrop-blur-sm">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a href="/rutas" className="bg-brand-primary hover:bg-brand-light hover:text-brand-primary text-white font-heading font-bold uppercase text-xs tracking-widest px-10 py-4 transition duration-300 shadow-lg">
              Ver Expediciones
            </a>
            <a href="/equipo" className="border border-white hover:bg-brand-light hover:text-brand-dark text-white font-heading font-bold uppercase text-xs tracking-widest px-10 py-4 transition duration-300">
              Nuestro Equipo
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center items-center gap-10 md:gap-20 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            <div className="flex flex-col items-center group">
              <i className="fas fa-hiking text-4xl mb-2 text-brand-dark group-hover:text-brand-primary transition"></i>
              <span className="font-heading font-bold text-xs tracking-widest uppercase">Trek Chile</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="font-heading font-bold text-2xl tracking-tighter text-brand-dark uppercase border-b-2 border-brand-primary pb-1">SERNATUR <i className="fas fa-check-circle text-xs align-top text-brand-primary"></i></span>
            </div>
            ...
            <div className="flex flex-col items-center group">
              <i className="fas fa-mountain text-3xl mb-1 text-brand-dark group-hover:text-brand-primary transition"></i>
      ...
      <section className="py-20 bg-brand-light bg-topo-pattern relative">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
            <div className="w-full md:w-1/2 relative group">
              ...
              <div className="absolute -top-4 -left-4 bg-brand-primary text-white px-4 py-2 text-xs font-bold uppercase tracking-widest shadow-lg z-10">
            ...
            <div className="w-full md:w-1/2 md:pl-10">
              ...
              <a href="/rutas/circuito-w" className="inline-flex items-center text-brand-dark font-heading font-bold uppercase text-sm tracking-widest hover:text-brand-primary transition group">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 mb-20">
            <div className="w-full md:w-1/2 relative group">
              ...
              <div className="absolute -top-4 -right-4 bg-brand-primary text-white px-4 py-2 text-xs font-bold uppercase tracking-widest shadow-lg z-10">
            ...
            <div className="w-full md:w-1/2 md:pr-10 text-left md:text-right">
              ...
              <a href="/rutas/volcan-villarrica" className="inline-flex items-center flex-row-reverse text-brand-dark font-heading font-bold uppercase text-sm tracking-widest hover:text-brand-primary transition group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group relative overflow-hidden h-[450px] hover-zoom cursor-pointer shadow-lg">
              ...
              <div className="absolute bottom-8 left-8 text-white">
                <span className="text-[10px] font-bold font-heading bg-brand-primary px-2 py-1 uppercase tracking-widest mb-3 inline-block rounded-sm">Cajón del Maipo</span>
            ...
            <div className="group relative overflow-hidden h-[450px] hover-zoom cursor-pointer shadow-lg mt-0 md:-mt-8">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/80 via-transparent to-transparent opacity-80"></div>
              <div className="absolute bottom-8 left-8 text-white">
                <span className="text-[10px] font-bold font-heading bg-brand-primary px-2 py-1 uppercase tracking-widest mb-3 inline-block rounded-sm text-white">Carretera Austral</span>
            ...
            <div className="group relative overflow-hidden h-[450px] hover-zoom cursor-pointer shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/80 via-transparent to-transparent opacity-80"></div>
              <div className="absolute bottom-8 left-8 text-white">
                <span className="text-[10px] font-bold font-heading bg-brand-primary px-2 py-1 uppercase tracking-widest mb-3 inline-block rounded-sm">San Pedro</span>
      ...
      <section className="py-20 bg-brand-light">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="space-y-4">
            {/* Date Item 1 */}
            <div className="group bg-brand-light border-2 border-gray-200 hover:border-brand-primary hover:bg-brand-primary/5 rounded-lg p-4 flex flex-col md:flex-row items-center justify-between transition duration-300 cursor-pointer shadow-sm hover:shadow-lg">
      ...
      <section id="reserva" className="py-24 relative bg-brand-dark text-white overflow-hidden flex items-center">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="w-full lg:w-1/2 bg-white/5 backdrop-blur-sm p-8 md:p-10 border border-white/10 rounded-sm">
              <form className="space-y-6">
                ...
                <a href="/reserva" className="block w-full bg-brand-primary hover:bg-brand-light hover:text-brand-dark text-white font-heading font-bold uppercase tracking-[0.2em] py-4 transition duration-300 mt-4 text-center">
                  Solicitar Reserva
                </a>
              </form>
            </div>
